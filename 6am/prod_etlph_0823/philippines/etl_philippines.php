...
require_once dirname(__DIR__) . '/philippines/src/init_loader.php';
require_once dirname(__DIR__) . '/philippines/etl/demo/Demo.php';
require_once dirname(__DIR__) . '/philippines/etl/farmer_meeting/Meeting.php';
require_once dirname(__DIR__) . '/philippines/etl/retailer_visit/Retailer.php';
require_once dirname(__DIR__) . '/philippines/etl/geo_hierarchy/Region.php';
require_once dirname(__DIR__) . '/philippines/etl/geo_hierarchy/Territory.php';
require_once dirname(__DIR__) . '/philippines/etl/geo_hierarchy/Zone.php';
require_once dirname(__DIR__) . '/philippines/etl/teams/Teams.php';
require_once dirname(__DIR__) . '/philippines/etl/users/User.php';
require_once dirname(__DIR__) . '/philippines/etl/portal_settings/PortalSetting.php';
require_once dirname(__DIR__) . '/philippines/etl/complaints/Complaint.php';
require_once dirname(__DIR__) . '/philippines/etl/crops/Crop.php';
require_once dirname(__DIR__) . '/philippines/etl/products/Product.php';
require_once dirname(__DIR__) . '/philippines/etl/target_activities/TargetActivity.php';
...
function run()
{
    include dirname(__DIR__) . '/philippines/config/countries.php';

    echo Logs::success("ETL Philippines Process Starts: " . date('Y-m-d H:i:s') . "\n");
    ...
    echo Logs::success("ETL Philippines Process Completed: " . date('Y-m-d H:i:s') . "\n");
}
