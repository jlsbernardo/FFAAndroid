...
require_once dirname(__DIR__) . '/indonesia/src/init_loader.php';
require_once dirname(__DIR__) . '/indonesia/etl/demo/Demo.php';
require_once dirname(__DIR__) . '/indonesia/etl/farmer_meeting/Meeting.php';
require_once dirname(__DIR__) . '/indonesia/etl/retailer_visit/Retailer.php';
require_once dirname(__DIR__) . '/indonesia/etl/geo_hierarchy/Region.php';
require_once dirname(__DIR__) . '/indonesia/etl/geo_hierarchy/Territory.php';
require_once dirname(__DIR__) . '/indonesia/etl/geo_hierarchy/Zone.php';
require_once dirname(__DIR__) . '/indonesia/etl/teams/Teams.php';
require_once dirname(__DIR__) . '/indonesia/etl/users/User.php';
require_once dirname(__DIR__) . '/indonesia/etl/portal_settings/PortalSetting.php';
require_once dirname(__DIR__) . '/indonesia/etl/complaints/Complaint.php';
require_once dirname(__DIR__) . '/indonesia/etl/crops/Crop.php';
require_once dirname(__DIR__) . '/indonesia/etl/products/Product.php';
require_once dirname(__DIR__) . '/indonesia/etl/target_activities/TargetActivity.php';
...
function run()
{
    include dirname(__DIR__) . '/indonesia/config/countries.php';

    echo Logs::success("ETL Indonesia Process Starts: " . date('Y-m-d H:i:s') . "\n");
    ...
    echo Logs::success("ETL Indonesia Process Completed: " . date('Y-m-d H:i:s') . "\n");
}
