...
require_once dirname(__DIR__) . '/thailand/src/init_loader.php';
require_once dirname(__DIR__) . '/thailand/etl/demo/Demo.php';
require_once dirname(__DIR__) . '/thailand/etl/farmer_meeting/Meeting.php';
require_once dirname(__DIR__) . '/thailand/etl/retailer_visit/Retailer.php';
require_once dirname(__DIR__) . '/thailand/etl/geo_hierarchy/Region.php';
require_once dirname(__DIR__) . '/thailand/etl/geo_hierarchy/Territory.php';
require_once dirname(__DIR__) . '/thailand/etl/geo_hierarchy/Zone.php';
require_once dirname(__DIR__) . '/thailand/etl/teams/Teams.php';
require_once dirname(__DIR__) . '/thailand/etl/users/User.php';
require_once dirname(__DIR__) . '/thailand/etl/portal_settings/PortalSetting.php';
require_once dirname(__DIR__) . '/thailand/etl/complaints/Complaint.php';
require_once dirname(__DIR__) . '/thailand/etl/crops/Crop.php';
require_once dirname(__DIR__) . '/thailand/etl/products/Product.php';
require_once dirname(__DIR__) . '/thailand/etl/target_activities/TargetActivity.php';
...
function run()
{
    include dirname(__DIR__) . '/thailand/config/countries.php';

    echo Logs::success("ETL Thailand Process Starts: " . date('Y-m-d H:i:s') . "\n");
    ...
    echo Logs::success("ETL Thailand Process Completed: " . date('Y-m-d H:i:s') . "\n");
}
