...
require_once dirname(__DIR__) . '/malaysia/src/init_loader.php';
require_once dirname(__DIR__) . '/malaysia/etl/demo/Demo.php';
require_once dirname(__DIR__) . '/malaysia/etl/farmer_meeting/Meeting.php';
require_once dirname(__DIR__) . '/malaysia/etl/retailer_visit/Retailer.php';
require_once dirname(__DIR__) . '/malaysia/etl/geo_hierarchy/Region.php';
require_once dirname(__DIR__) . '/malaysia/etl/geo_hierarchy/Territory.php';
require_once dirname(__DIR__) . '/malaysia/etl/geo_hierarchy/Zone.php';
require_once dirname(__DIR__) . '/malaysia/etl/teams/Teams.php';
require_once dirname(__DIR__) . '/malaysia/etl/users/User.php';
require_once dirname(__DIR__) . '/malaysia/etl/portal_settings/PortalSetting.php';
require_once dirname(__DIR__) . '/malaysia/etl/complaints/Complaint.php';
require_once dirname(__DIR__) . '/malaysia/etl/crops/Crop.php';
require_once dirname(__DIR__) . '/malaysia/etl/products/Product.php';
require_once dirname(__DIR__) . '/malaysia/etl/target_activities/TargetActivity.php';
...
function run()
{
    include dirname(__DIR__) . '/malaysia/config/countries.php';

    echo Logs::success("ETL Malaysia Process Starts: " . date('Y-m-d H:i:s') . "\n");
    ...
    echo Logs::success("ETL Malaysia Process Completed: " . date('Y-m-d H:i:s') . "\n");
}
