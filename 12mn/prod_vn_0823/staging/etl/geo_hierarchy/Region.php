        ...
        foreach ($dataChunkeds as $dataChunked) {
            ...
            foreach ($dataChunked as $regionRNAFields) {
                ...
                if (!$isInsertedStaging) {
                    ...
                    $results = $this->getInsertedStaging($ffaRecordStagingList, $regionRNAFields['ffa_id']);
                    if ($regionRNAFields['caption'] != $results['caption'] || $regionRNAFields['level'] != $results['level'] || $regionRNAFields['node_level'] != $results['node_level']) {
